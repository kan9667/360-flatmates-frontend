# 360 Flatmates Screen 14: Review & Publish
...
Primary request: Recreate the review screen in the same style, but change it to a review-and-submit state with moderation messaging. Show listing preview, quick facts, and an indigo CTA such as 'Publish Listing', plus note that the listing will go under review.
